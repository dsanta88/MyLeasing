...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("23225", "David", "Fernando", "santadavid88@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Pedro", "Ocampo", "santadavid88@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("3030", "Juan", "Zuluaga", "juansanta@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
